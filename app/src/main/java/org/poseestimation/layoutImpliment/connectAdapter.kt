...
class connectAdapter(  //数据项
    ...
    override fun getView(i: Int, view: View?, viewGroup: ViewGroup): View {
        ...
        if (view == null) {
            view = LayoutInflater.from(viewGroup.context).inflate(org.poseestimation.R.layout.mylist_item, null)
            viewHolder = ViewHolder()
            viewHolder.text = view.findViewById(org.poseestimation.R.id.text)
            viewHolder.btn = view.findViewById(org.poseestimation.R.id.btn) as Button
