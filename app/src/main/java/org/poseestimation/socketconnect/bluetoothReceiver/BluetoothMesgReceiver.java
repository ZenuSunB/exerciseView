...
import org.poseestimation.socketconnect.communication.slave.ReceiveCommandThreadFactory;
            ...
            public void run() {
                try {
                    ...
                    while(isOpen){
                        ...
                        threadPool.execute(new BluetoothMesgReceiver.BluetoothMesgRunnable(socket));
                    }
